                                  ...
                                  Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        children: <Widget>[
                                          Text("Rekod tertinggi : 95%",style: TextStyle(fontSize: 16,fontFamily: 'bree',color: Colors.green[500]),),
                                        ],
                                      ),
                                    ],
                                  ),
                                  ...
                                  Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        children: <Widget>[
                                          Text("Rekod tertinggi: 50%",style: TextStyle(fontSize: 16,fontFamily: 'bree',color: Colors.amber[600]),),
                                        ],
                                      ),
                                    ],
                                  ),
                                ...
                                Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      children: <Widget>[
                                        Text("Rekod tertinggi: 0%",style: TextStyle(fontSize: 16,fontFamily: 'bree',color: Colors.white),),
                                      ],
                                    ),
                                  ],
                                ),
